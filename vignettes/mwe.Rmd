...
`mirage_vs(data, n1, n2, gamma=3, sigma=2, eta.init=0.1, max.iter = 10000, tol = 1e-05, verbose = TRUE)` 



`mirage(data, n1, n2, gamma=3, sigma=2, eta.init=0.1, delta.init=0.1, estimate.delta = TRUE, max.iter = 10000, tol = 1e-05, verbose = TRUE)` 
...
By default,  $\gamma=3, \sigma=2, \eta_0=0.1$ and it is up to users to choose whatever you want, but $\eta$ initial must be a positive number within $(0,1)$.
